...
git clone https://github.com/PaulPCIO/antd-themed-cssvars
...
# 
npm i -S d3 turf crossfilter2

# Mapbox
npm i -S react-map-gl react-map-gl-geocoder mapbox-gl dc react-splitter-layout

# NOT INSTALLED
npm i -S joi-browser node-uuid 
npm i -S monaco-editor-webpack-plugin monaco-editor react-monaco-editor json-parse-safe
